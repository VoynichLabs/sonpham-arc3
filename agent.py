...
Discovery strategy:
1. OBSERVE distinct coloured regions, small shapes, edge bars.
2. EXPERIMENT by trying different actions and tracking what changes.
3. IDENTIFY your character/cursor, goals, obstacles.
4. BUILD a rule model, then act strategically."""
